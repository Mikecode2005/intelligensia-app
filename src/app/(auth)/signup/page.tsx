          ...
          <div className="hidden lg:flex flex-col space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 text-xl max-w-md leading-relaxed">
                Join our world-class community of innovators and researchers. Create your account to get started.
              </p>
            </div>
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="glass-card p-10 rounded-xl shadow-2xl">
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-white/50">Join our community of innovators and researchers.</p>
              </div>
              <SignUpForm />
            </div>
          </div>
